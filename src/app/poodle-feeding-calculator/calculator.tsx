...
export default function PoodleFeedingCalculator() {
  ...
  function calculateFood() {
    ...
    let grams = age === "puppy" ? dogWeight * 32 : dogWeight * 22;
      ...
      {result && (
        <div className="mt-8 rounded-2xl bg-slate-100 p-6">
          ...
          <p className="mt-4 text-sm leading-6 text-slate-500">
            This estimate may vary depending on Poodle size, activity level,
            food type, metabolism, body condition, and veterinarian guidance.
          </p>
        </div>
      )}
    </div>
