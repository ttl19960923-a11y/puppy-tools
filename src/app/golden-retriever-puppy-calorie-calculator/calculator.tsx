...
export default function GoldenRetrieverPuppyCalorieCalculator() {
      ...
      {result && (
        <div className="mt-8 rounded-2xl bg-slate-100 p-6">
          ...
          <p className="mt-4 text-sm leading-6 text-slate-500">
            This is a general estimate only. Golden Retriever puppy calorie
            needs can vary by growth rate, activity level, food type, and
            health.
          </p>
        </div>
      )}
