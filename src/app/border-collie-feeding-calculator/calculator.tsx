...
export default function BorderCollieFeedingCalculator() {
      ...
      {result && (
        <div className="mt-8 rounded-2xl bg-slate-100 p-6">
          ...
          <p className="mt-4 text-sm leading-6 text-slate-500">
            ...
            metabolism, body condition, training intensity, and veterinarian
            guidance.
          </p>
        </div>
      )}
