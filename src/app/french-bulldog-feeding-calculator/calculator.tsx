...
export default function FrenchBulldogFeedingCalculator() {
  ...
  function calculateFood() {
    ...
    let grams = age === "puppy" ? dogWeight * 28 : dogWeight * 18;
      ...
      {result && (
        <div className="mt-8 rounded-2xl bg-slate-100 p-6">
          ...
          <p className="mt-4 text-sm leading-6 text-slate-500">
            ...
            metabolism, body condition, and veterinarian guidance.
          </p>
        </div>
      )}
    </div>
