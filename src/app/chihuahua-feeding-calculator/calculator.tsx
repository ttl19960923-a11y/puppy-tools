...
export default function ChihuahuaFeedingCalculator() {
  ...
  function calculateFood() {
    ...
    let grams = age === "puppy" ? dogWeight * 35 : dogWeight * 25;
      ...
      {result && (
        <div className="mt-8 rounded-2xl bg-slate-100 p-6">
          ...
          <p className="mt-4 text-sm leading-6 text-slate-500">
            This estimate may vary depending on food type, calorie density,
            activity level, body condition, and veterinarian guidance.
          </p>
        </div>
      )}
    </div>
